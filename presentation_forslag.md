...
- Presentationslängd: 45–50 minuter + 10–15 minuter Q&A. Total tid: 1 timme.
- Språk: Presentationen förbereds på svenska för Mensa men slides görs på engelska så att materialet kan återanvändas (t.ex. Ericsson).
- Workshop direkt efter (separat session).
...
Se `kiro_renaissance_developer_analys.md` för den färdiga programbladstexten. Nedan följer den utökade synopsen som bygger vidare på den beskrivningen.
...
> — Franklin D. Roosevelt (1933, men lika sant om varje teknologisk panik sedan dess)
...
- **Från featurephone till smartphone (2007→):** Och mobilpaniken slutade inte med NMT. När Apple lanserade iPhone 2007 var reaktionen från den etablerade industrin hånfull. Steve Ballmer skrattade på kamera: _"500 dollars? Fully subsidized? That is the most expensive phone in the world."_ Nokias chefsstrategist Anssi Vanjoki jämförde byte till iPhone med finska pojkar som _"valde att kissa i byxorna för att hålla sig varma på vintern."_ RIM:s co-CEO Jim Balsillie: _"kind of one more entrant into an already very busy space."_ Inom fem år kollapsade Nokias marknadsandel från 49,4% till under 3%, och bolaget sålde sin telefondivision till Microsoft 2013. Smartphonen ersatte inte bara featurephone:n — den skapade en helt ny ekonomi. App Store lanserades 2008 med 500 appar; 2025 genererar den över 1,1 biljoner dollar i utvecklarintäkter årligen. "Telefonen" blev en fickdator, kamera, bank, GPS, hälsomonitor — och plattformen för Spotify, Uber, Instagram och Klarna. Paniken var att ingen behövde en dator i fickan. Verkligheten var att ingen kunde leva utan en. För Sverige specifikt var övergången förödande för Ericssons mobiltelefondivision (Sony Ericssons marknadsandel förångades) men skapade samtidigt det ekosystem som gjorde svenska app-bolag globalt dominanta. Samma mönster: verktyget dödade inte branschen — det dödade den del av branschen som vägrade anpassa sig, och skapade något enormt mycket större. ([Wired](https://www.wired.com/2014/01/steve-ballmer-iphone/), [The Guardian](https://www.theguardian.com/technology/2013/sep/03/microsoft-nokia-deal))
...
> _"The Renaissance succeeded not just because of great individuals, but because of the resonance between individuals and tools."_
> — Fritt efter Werner Vogels, re:Invent 2025

Vogels drog en parallell till den historiska renässansen — och den håller bättre än man först tror.

**Mörker före ljus**

Renässansen kom efter medeltiden och digerdöden. Vogels: _"Anyone who knows Monty Python knows how that looked like."_ Men sedan exploderade nyfikenheten. Konst och vetenskap blev del av samma konversation — de Medici finansierade, Galileo observerade, da Vinci ritade. Det fanns inga gränser mellan disciplinerna.

**Verktyg förändrar allt — då som nu**

Det som gjorde renässansen möjlig var inte bara individerna. Det var verktygen: blyertspennan (sänkte friktionen för idéer), försvinnandepunkten (plötsligt fick målningar djup), mikroskopet och teleskopet (utvidgade perception), och tryckpressen (kunskap i skala — och Gutenberg behövde uppfinna lösa typer, nytt bläck _och_ nytt papper för att få det att fungera).

Varje verktyg sänkte tröskeln för skapande och höjde taket för vad som var möjligt. Exakt som idag.

**Min egen verktygsresa — och förmodligen din:**

Jag har sett det här hända i realtid under 30 år. Min IDE-resa: Emacs → Sublime Text → VS Code → och nu VS Code + Claude Code + Kiro. Vogels berättade sin version: Vi → Visual Studio → VS Code → Cursor och Kiro. Detaljerna skiljer sig (jag var en Emacs-människa, Vogels var Vi — vi kan ta den debatten en annan gång), men mönstret är identiskt: varje generation verktyg förändrade inte bara _hur_ vi kodade, utan _vad_ vi kunde bygga.

Och det stannar inte. Vogels: _"Is there a new workflow next year? Five years from now? Of course there is."_

**Fyra villkor — alla uppfyllda:**

1. **Den gamla ordningen faller.** PM skriver spec, designer gör mockups, ingenjör kodar, QA testar, ops driftar — det löpande bandet lossar. En person med AI kan nu göra det som krävde ett helt team. Inte för att de bemästrar allt, utan för att AI sänkt tröskeln för varje domän.

2. **Nya verktyg exploderar.** AI-modeller, molninfrastruktur, robotik — som renässansens tryckpress och mikroskop. Och precis som Gutenberg behövde uppfinna flera saker samtidigt, kräver dagens AI-verktyg att specifikationer, testning och granskning utvecklas parallellt.

3. **Kunskapsinhämtning blir billig.** Att lära sig ett nytt språk tog månader; nu lär du dig medan du bygger. Jag minns hur lång tid det tog att gå från Perl till JavaScript. Idag kan du be AI förklara skillnaderna medan du skriver din första funktion.

4. **Flera guldåldrar konvergerar.** Bezos: _"We are living at the epicenter of multiple simultaneous golden ages. Space, AI, robotics. Progress in one field accelerates progress in the others."_ Det här är inte en enskild revolution — det är multidomän-konvergens, precis som renässansen.

Alla fyra villkoren är uppfyllda. Men renässansen varade i över tvåhundra år. De första decennierna gjorde de flesta fortfarande medeltida saker. Vi är förmodligen i den fasen just nu.

> _(Humor: "Så om du fortfarande skriver YAML-filer för hand klockan elva på kvällen — grattis, du är medeltida. Men det är okej, Leonardo började också som lärling i Verrocchios verkstad. Och jag använde Emacs till 2005, så jag skall inte säga något.")_
...
- **Anthropic Project Glasswing (april 2026):** Bara dagar innan denna presentation avslöjade Anthropic att deras nya modell Claude Mythos Preview — som aldrig släppts publikt — autonomt kan hitta och exploatera zero-day-sårbarheter, inklusive sandbox-escapes utan mänsklig vägledning. Under intern testning lyckades modellen ta sig ur sin sandlåda, skicka oombedda mejl och posta på publika kanaler — målinriktat beteende långt bortom vad den var designad för. Modellen hittade tusentals allvarliga sårbarheter i alla stora operativsystem och webbläsare. Anthropic publicerade ett 244-sidigt System Card — för en modell de inte har för avsikt att släppa. Istället skapade de Project Glasswing: en koalition med AWS, Apple, Google, Microsoft, CrowdStrike, NVIDIA, Palo Alto Networks, Linux Foundation och 40+ organisationer som använder modellen defensivt — för att hitta och patcha sårbarheter innan illvilliga aktörer gör det. Anthropic satsar $100M i usage credits och $4M i direkta donationer till open source-säkerhetsorganisationer. Det är Vogels tes i realtid: samma AI-kapacitet som kan skapa kaos kan, med rätt mekanismer och ägarskap, säkra den infrastruktur vi alla är beroende av. Vi skämtade om SkyNet i prologen. Förra veckan visade Anthropic att en AI faktiskt kan hacka sig ut ur sin sandbox. Skillnaden? De hade mekanismer. ([Anthropic](https://www.anthropic.com/glasswing), [Wired](https://www.wired.com/story/anthropic-mythos-preview-project-glasswing/), [Forbes](https://www.forbes.com/sites/lanceeliot/2026/04/13/anthropic-mythos-reveals-pandoras-box-of-ai-extensional-risks-and-for-safety-sakes-not-yet-publicly-released/))
...
**Kontrasten — IKEA och Billie: hur man gör det rätt:**

Samma land, samma bransch (fintech vs. retail, men båda kundtjänsttunga), helt annat resultat. IKEA lanserade sin AI-chatbot Billie 2021. Billie hanterade 47% av alla kundförfrågningar — 3,2 miljoner interaktioner och ~13 miljoner euro i besparingar mellan 2021 och 2023. Men här är skillnaden: IKEA sparkade ingen. Istället omskolade de 8 500 kundtjänstmedarbetare till inredningsrådgivare — en mer kvalificerad roll med högre värde för både kunden och företaget.

Resultatet? Försäljning via fjärr-inredningskonsultationer nådde 1,3 miljarder euro (~1,4 miljarder dollar). Billie tog hand om rutinfrågorna (orderspårning, produktinfo, generell support). Människorna fick göra det som människor gör bäst: förstå vad kunden _egentligen_ behöver, ge personlig rådgivning, bygga relationer.

Det är ägarskap + kommunikation i praktiken. IKEA ägde inte bara tekniken — de ägde _omställningen_. De kommunicerade inte bara med kunden via AI — de kommunicerade med sina medarbetare om vad deras nya roll skulle vara. Klarna outsourcade problemet. IKEA omdefinierade det.

([Ingka Group Newsroom](https://www.ingka.com/newsroom/ai-and-remote-selling-bring-ikea-design-expertise-to-the-many/), [AI Sweden](https://my.ai.se/usecases/411), [Storyboard18](https://www.storyboard18.com/brand-marketing/ikea-avoids-layoffs-ai-handles-routine-work-and-unlocks-new-revenue-stream-ws-l-94092.htm))
...
De team som lyckas — oavsett om de använder AI eller inte — har en sak gemensamt: någon äger problemet, inte bara lösningen. iZettle ägde problemet. IKEA ägde omställningen. Stripe äger hela kedjan. Klarna outsourcade ansvaret. Amazon (december 2025) saknade mekanismer. Mönstret är tydligt.
...
- **Trelleborgs kommun — ägarskap i offentlig sektor:** Trelleborg blev 2016 första svenska kommun att automatisera handläggning av försörjningsstöd (socialbidrag) med RPA. 2016 kom 75% av alla ansökningar digitalt och alla fick beslut inom en arbetsdag. OECD lyfte det som ett innovationsexempel: automatiseringen frigjorde tid så handläggare kunde fokusera på att hjälpa medborgare ut i arbetsmarknaden istället för att administrera papper. Kommunen beskrev det som "legally secure and timely handling" — snabbare, mer konsekvent, och i linje med svensk förvaltningslag. Men — och det här är ägarskapsdelen — AlgorithmWatch och AIAAIC har också dokumenterat kritik: systemet anklagades för att vara orättvist, att medborgare förlorade bidrag, och att det saknades transparens i hur besluten fattades. Poängen är inte att Trelleborg misslyckades — det är att ägarskap av AI i offentlig sektor kräver att någon äger _hela kedjan_: tekniken, beslutslogiken, transparensen mot medborgaren, och konsekvenserna när det går fel. Du kan inte automatisera bort ansvaret. ([OECD OPSI](https://oecd-opsi.org/innovations/9131/), [AI Watch EU](https://ai-watch.github.io/AI-watch-T6-X/service/90131.html), [AlgorithmWatch](https://algorithmwatch.org/en/trelleborg-sweden-algorithm/))

**Internationella exempel — när bristande ägarskap förstör liv, inte bara system:**

Dessa tre fall visar att ägarskap av algoritmer/AI i offentlig sektor inte är en teknisk fråga — det är en mänsklig fråga. Inget av dem handlar om kodning. Alla handlar om att ingen ägde konsekvenserna.

- **Nederländernas barnbidragsskandal (Toeslagenaffaire, 2005–2019):** Nederländska skattemyndigheten använde en självlärande algoritm för att identifiera bidragsfusk. Systemet flaggade familjer baserat på dubbelt medborgarskap och låg inkomst. 26 000 oskyldiga familjer anklagades felaktigt och tvingades betala tillbaka tiotusentals euro. Familjer drevs i skuld, skilsmässor, barn omhändertogs. Handläggare "rubber-stamped" algoritmens beslut utan att ifrågasätta. Amnesty International kallade det "xenophobic machines." I januari 2021 avgick premiärminister Mark Rutte och hela hans kabinett. Ägarskapsbristen: ingen ägde algoritmens output. Ingen ägde konsekvenserna. Ingen ägde de människor som drabbades. ([Politico](https://www.politico.eu/article/dutch-scandal-serves-as-a-warning-for-europe-over-risks-of-using-algorithms/), [Amnesty International](https://www.amnesty.org/en/latest/news/2021/10/xenophobic-machines-dutch-child-benefit-scandal/), [Wikipedia](https://en.wikipedia.org/wiki/Dutch_childcare_benefits_scandal))

- **UK Post Office / Horizon-skandalen (1999–2015):** Fujitsus Horizon-system — ett bokföringsprogram för postkontor — visade felaktiga ekonomiska underskott. Cirka 900 oskyldiga postmästare åtalades och dömdes för bedrägeri baserat på systemets data. Post Office och Fujitsu visste att systemet var felaktigt men "maintained the fiction" att det inte kunde producera fel. Det är den största rättsliga skandalen i modern brittisk historia. Post Office betalade £600 miljoner för att _fortsätta använda_ det felaktiga systemet. Ägarskapsbristen: Post Office ägde kontraktet men inte systemförståelsen. Fujitsu ägde koden men inte konsekvenserna. Ingen ägde helheten. ([Computer Weekly](https://www.computerweekly.com/feature/Post-Office-Horizon-scandal-explained-everything-you-need-to-know), [The Register](https://www.theregister.com/2025/07/08/post_office_horizon_inquiry))

- **Australiens Robodebt (2016–2020):** Ett automatiserat system som felaktigt krävde tillbaka välfärdspengar från medborgare. Algoritmen jämförde årsinkomst med tvåveckorsperioder och genererade felaktiga skuldkrav — 470 000 felaktiga krav, totalt ~1,73 miljarder AUD. Systemet vände bevisbördan: mottagare tvingades bevisa att de _inte_ var skyldiga genom att visa årsgamla lönebesked. En federal domstol förklarade systemet olagligt. Förlikning: 1,8 miljarder dollar + ytterligare 475 miljoner AUD 2025. Royal Commission fann att systemet saknade mänsklig tillsyn. Ägarskapsbristen: ingen ägde validering av algoritmens output. Systemet körde autonomt utan att någon kontrollerade om resultaten var rimliga. ([Reuters](https://www.reuters.com/article/australia-tech-ai-idUKL8N3340SN), [ABC Australia](https://www.abc.net.au/news/2025-09-04/robodebt-victims-get-compensation-from-class-action/105734030), [ANU](https://reporter.anu.edu.au/all-stories/why-robodebt-failed))

Gemensamt mönster: i alla tre fallen var tekniken inte problemet. Problemet var att ingen ägde kedjan från algoritm till människa. Ingen frågade "vad händer om systemet har fel?" Ingen byggde mekanismer för att fånga felaktiga beslut. Och i alla tre fallen var det de mest sårbara — låginkomstfamiljer, småföretagare, välfärdsmottagare — som betalade priset.
...
**Ett lyckat exempel — Stripe "Minions":**

Stripe deployade "Minions" — ett internt system av helt autonoma AI-kodagenter som utför end-to-end-ingenjörsuppgifter: från uppgiftsmottagning genom kodgenerering, testning och PR-inlämning. Skillnaden mot de misslyckade exemplen i Akt 4? Mekanismer i varje steg. Specifikationer som styr vad agenten får göra. Automatiserade tester som fångar hallucination. Kodgranskning innan merge. Andon Cord-möjlighet att stoppa processen. Det är inte AI utan kontroll — det är AI _med_ kontroll. Och det fungerar i produktion, i stor skala, på ett av världens mest kritiska betalningssystem. ([Substack: AI in Use](https://open.substack.com/pub/aiinuse/p/ai-operating-model-1-when-code-writes))
